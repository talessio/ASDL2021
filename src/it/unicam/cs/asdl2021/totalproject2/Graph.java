...
public abstract class Graph<L> {
     ...
     * presente
     * @throws NullPointerException          se il nodo passato è null
     * @throws UnsupportedOperationException se l'implementazione del grafo
     ...
     * @throws IllegalArgumentException      se un nodo con l'etichetta
     ...
     * al secondo.
     *
     * @param node1 il primo nodo
     * @param node2 il secondo nodo
     ...
     * @throws NullPointerException     se almeno uno dei due nodi passati è
     *                                  null
     ...
     *
     * @param i l'indice del primo nodo
     * @param j l'indice del secondo nodo
     ...
     * ordine
     * @throws IndexOutOfBoundsException     se almeno uno degli indici
     ...
     * @throws IllegalArgumentException se almeno uno dei due nodi
     *                                  specificati nell'arco non esiste
     * @throws IllegalArgumentException se l'arco è orientato e questo grafo
